...
<html lang="fa"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="stylesheet" href="./استعلام گواهینامه_files/flaticon.css">

    <link rel="stylesheet" href="./استعلام گواهینامه_files/style.css">
    <link rel="stylesheet" href="./استعلام گواهینامه_files/style.responsive.css">
...
.TKXFYjyTT7BRVXk2l6uF a {
  ...
  </style><style id="raychat_frame_styles">
    .raychat_frame{
      position: fixed;
      z-index: 2000000000;
      width: 100px; 
        ...
        <div class="header">
            <header>
                <div class="app-main-menu">
                    <button class="ibtn-round" data-mobile-account=""><span class="flaticon-menu"></span></button>
                </div>
                <div class="heading">
                    <a href="https://mftplus.com/"><img src="./استعلام گواهینامه_files/mftlogo.png"></a>
                </div>
                <div class="main-menu">
                    <ul>
                                                    <li data-main-menu="">
                                <a target="_blank" class="" href="https://mftplus.com/radio">آوا و نوای مجتمع فنی تهران(کتب صوتی)</a>
                                                            </li>
                                                    <li data-main-menu="">
                                <a class="" href="https://mftplus.com/departments">دپارتمان ها</a>
                                                            </li>
                                                    <li data-main-menu="">
                                <a class="" href="https://mftplus.com/academies">مراکز</a>
                                                            </li>
                                                    <li data-main-menu="">
                                <a class="" href="https://mftplus.com/calendar">تقویم آموزشی</a>
                                                            </li>
                                                    <li data-main-menu="">
                                <a class="" href="https://mftplus.com/">خدمات آموزشی</a>
                                                                    <ul class="sub">
                                                                                    <li><a href="https://mftplus.com/resellers">امور نمایندگیها</a>
                                                                                            </li>
                                                                                    <li><a href="https://mftplus.com/international">اموربین الملل</a>
                                                                                            </li>
                                                                                    <li><a href="https://mftplus.com/orgedu">آموزشهای سازمانی</a>
                                                                                            </li>
                                                                                    <li><a href="https://mftplus.com/mfttalent">کاریابی الکترونیکی (کارتلنت)</a>
                                                                                            </li>
                                                                            </ul>
                                                            </li>
                                                    <li data-main-menu="">
                                <a class="" href="https://mftplus.com/">روابط عمومی</a>
                                                                    <ul class="sub">
                                                                                    <li><a href="https://mftplus.com/news">اخبار</a>
                                                                                            </li>
                                                                                    <li><a target="_blank" href="https://mftplus.com/articles">مقالات</a>
                                                                                            </li>
                                                                                    <li data-main-menu-sub=""><a href="https://mftplus.com/nl1401">خبرنامه</a>
                                                                                                    <ul class="sub2">
                                                                                                                    <li><a href="https://mftplus.com/nl1402">خبرنامه الکترونیکی 1402</a></li>
                                                                                                                    <li><a href="https://mftplus.com/nl1401">خبرنامه الکترونیکی 1401</a></li>
                                                                                                            </ul>
                                                                                            </li>
                                                                                    <li><a target="_blank" href="https://mftplus.com/csr">مسئولیت های اجتماعی(CSR)</a>
                                                                                            </li>
                                                                                    <li><a href="https://mftplus.com/catalog"> دفترچه دیجیتال معرفی فعالیت های مجتمع فنی تهران</a>
                                                                                            </li>
                                                                            </ul>
                                                            </li>
                                            </ul>
                ...
                <div class="tools">
                    <button data-search-toggle="" id="searchBtn" class="ibtn-round"><span class="flaticon-search"></span></button>
                    <button data-account="" class="ibtn-round"><span class="flaticon-user"></span></button>
                    <div data-account="" id="usernameHolder">
                        <a class="inner-icon" href="https://mftplus.com/student/login">
                            حساب کاربری                            <span class="normal-btn-foreground flaticon-down-filled-triangular-arrow"></span>
                        </a>
                    </div>
                                            <div id="accountTools" class="account-tools">
                            <div class="body">
                                <a href="https://mftplus.com/student/login">
                                    <span class="flaticon flaticon-user"></span>
                                    ورود به حساب دانشپذیر
                                    <span class="flaticon flaticon-left-arrow"></span>
                                </a>
                                <a href="https://mftplus.com/teacher/login">
                                    <span class="flaticon flaticon-user-1"></span>
                                    ورود به حساب اساتید
                                    <span class="flaticon flaticon-left-arrow"></span>
                                </a>
                            </div>
                ...
                <div class="app-tools">
                    <button data-search-toggle="" class="ibtn-round"><span class="flaticon-search"></span></button>
                </div>
                <div id="accountToolsMobile" class="mobile-tools">
                    <button data-mobile-account-close="" class="ibtn-round btn-danger"><span class="flaticon-close"></span></button>
                    <div class="account-tools-mobile">
                                    ...
                                    پنل اساتید
                                                ...
                                                <div class="mobile-main-menu">
                                                            <a target="_blank" class="" href="https://mftplus.com/radio">آوا و نوای مجتمع فنی تهران(کتب صوتی)</a>
                                                                                            ...
                                                                                            <a class="" href="https://mftplus.com/academies">مراکز</a>
                                                                                            <a class="" href="https://mftplus.com/calendar">تقویم آموزشی</a>
                                                                                            <a class="active" href="https://mftplus.com/">خدمات آموزشی</a>
                                                                                                            <a class="sub-menu" href="https://mftplus.com/resellers">امور نمایندگیها</a>
                                                                                                                                                                                                        <a class="sub-menu" href="https://mftplus.com/international">اموربین الملل</a>
                                                                                                                                                                                                        <a class="sub-menu" href="https://mftplus.com/orgedu">آموزشهای سازمانی</a>
                                                                                                                                                                                                        <a class="sub-menu" href="https://mftplus.com/mfttalent">کاریابی الکترونیکی (کارتلنت)</a>
                                                                                                                                                                                                                                                            <a class="active" href="https://mftplus.com/">روابط عمومی</a>
                                                                                                            <a class="sub-menu" href="https://mftplus.com/news">اخبار</a>
                                                                                                                                                                                                        <a class="sub-menu" target="_blank" href="https://mftplus.com/articles">مقالات</a>
                                                                                                                                                                                                        <a class="sub-menu" href="https://mftplus.com/nl1401">خبرنامه</a>
                                                                                                                                    <a class="sub-sub-menu" href="https://mftplus.com/nl1402">خبرنامه الکترونیکی 1402</a>
                                                                                            <a class="sub-sub-menu" href="https://mftplus.com/nl1401">خبرنامه الکترونیکی 1401</a>
                                                                                                                                                                <a class="sub-menu" target="_blank" href="https://mftplus.com/csr">مسئولیت های اجتماعی(CSR)</a>
                                                                                                                                                                                                        <a class="sub-menu" href="https://mftplus.com/catalog"> دفترچه دیجیتال معرفی فعالیت های مجتمع فنی تهران</a>
                                                                                                                                                                                                                                                    </div>
                    </div>
                </div>
                <!---->
...
<div class="content">
	<div class="heading">
		<h2><span class="animated-bg"></span><span class="flaticon-medal"></span>استعلام گواهینامه</h2>
	</div>
	<div class="page-container">
		<div class="main">
			<div>
									<div class="mb-3">
						<div class="message message-success"><span class="flaticon flaticon-checked"></span>خانم / آقای بهار شیرازی‌ نژاد دوره HTML, CSS را از 29-05-1401 تا 28-09-1401 در این مرکز طی یک دوره 58 ساعته با موفقیت به پایان رسانیده است.</div>					</div>			<form method="POST">
				<div class="caption">برای بررسی وضعیت گواهینامه پایان دوره لطفا اطلاعات زیر را وارد کنید.</div>
				<div class="form-item">
					<label for="nationalcode">کد ملی</label>
					<input required="" id="nationalcode" name="nationalcode" value="0440465389">
				</div>
				<div class="form-item">
					<label for="code">کد گواهینامه</label>
					<input required="" id="code" name="code" value="1592509">
				</div>
				<div class="text-left">
					<input name="formbuttonsubmit" class="reg-btn filled" type="submit" value="استعلام">
				</div>
			</form>
		</div>
	</div>
...
<div class="footer mt-5">
    <div class="contact">
        <div>نیاز به مشاوره دارید؟</div>
        <p>همکاران ما آماده پاسخگویی به سوالات شما می باشند</p>
        <select>
                            <option>سعادت آباد (مرکزی) -&gt; ۰۲۱-۲۷۲۹</option>
                            ...
                            <option>بلوار کاوه(قیطریه) -&gt; ۲۲۷۶۸۹۸۰ - ۰۲۱</option>
                            <option>رودهن -&gt; ۷۶۵۰۸۵۶۲ - ۰۲۱</option>
                            <option>پرند -&gt; ۰۲۱-۵۶۷۹۳۷۱۶</option>
                            ...
                            <option>بروجن -&gt; ۳۴۲۳۶۳۴۴ - ۰۳۸</option>
                            <option>دزفول -&gt; ۰۶۱-۴۲۲۳۰۱۹۹</option>
                            <option>کیش -&gt; ۴۴۴۶۷۰۲۴ - ۰۷۶</option>
                            <option>چالوس -&gt; ۵۲۲۲۰۶۴۳ - ۰۱۱</option>
                            <option>گرگان -&gt; ۳۲۵۲۶۳۲۶ - ۰۱۷</option>
                            <option>نور -&gt; ۴۴۵۲۸۴۸۱ - ۰۱۱</option>
                            <option>شهرقدس -&gt; ۴۶۸۶۷۷۷۱ - ۰۲۱</option>
                            <option>بوشهر -&gt; ۳۳۵۳۵۰۲۲ - ۰۷۷</option>
                            <option>تبریز -&gt; ۰۴۱-۳۳۶۹۶۴۷۲</option>
                            <option>خرم آباد -&gt; ۳۳۳۳۵۵۰۶ - ۰۶۶</option>
                            <option>سبزوار -&gt; ۴۴۲۲۲۷۷۳ - ۰۵۱</option>
                            <option>قم -&gt; ۳۲۹۰۰۷۵۶ - ۰۲۵</option>
                            <option>لاهیجان -&gt; ۴۲۲۲۲۰۶۲ - ۰۱۳</option>
                            <option>شهركرد -&gt; ۳۳۳۹۸۰۰۷ - ۰۳۸</option>
                            <option>جویبار -&gt; ۴۲۵۳۵۰۱۰ - ۰۱۱</option>
                            <option>مرند -&gt; ۴۲۲۶۱۳۸۵ - ۰۴۱</option>
                            <option>دورود -&gt; ۴۳۲۳۰۵۶۶ - ۰۶۶</option>
                            <option>فردیس -&gt; ۰۲۶- ۳۶۵۲۶۰۵۵</option>
                            <option>شیراز -&gt; ۳۶۲۹۲۲۹۴ - ۰۷۱</option>
                            <option>بیرجند -&gt; ۳۲۰۴۳۰۳۲ - ۰۵۶</option>
                            <option>زنجان -&gt; ۳۳۴۷۴۸۱۵ - ۰۲۴</option>
                            <option>ساری -&gt; ۳۳۲۵۵۹۹۹ - ۰۱۱</option>
                            <option>شاهین شهر -&gt; ۴۵۲۲۸۲۰۱ - ۰۳۱</option>
                            <option>مشهد -&gt; ۹۱۰۱۰۹۵۰ - ۰۵۱</option>
                            <option>باملند(شمال غرب) -&gt; ۴۴۷۳۹۹۷۱ ۰۲۱</option>
                            <option>بندرعباس (زبان) -&gt; ۰۷۶-۹۱۰۱۴۴۲۵</option>
                            <option>نکا -&gt; ۳۴۷۴۳۱۶۱ - ۰۱۱</option>
                            <option>اکباتان -&gt; ۰۲۱-۴۴۶۸۵۰۰۹</option>
                            <option>اسلامشهر -&gt; ۰۲۱-۵۶۶۹۸۶۶۴</option>
                            <option>مطهری -&gt; ۸۸۷۱۳۲۵۳- ۰۲۱</option>
                            <option>آیت الله کاشانی (غرب) -&gt; ۰۲۱-۴۴۹۶۸۲۰۰</option>
                            <option>دهکده جهانی دانش و مهارت -&gt; ۸۸۷۲۶۶۵۸ - ۰۲۱</option>
                            <option>پرواز -&gt; ۰۲۱-۹۱۰۹۱۴۹۹</option>
                    </select>
    </div>
        <div class="details">
        <div class="header">مجتمع فنی تهران</div>
        <div class="address">
            <div>آدرس دفتر مرکزی</div>
            <p>
                سعادت آباد، بالاتر از ميدان كاج، خيابان دوم (شهيد عبقری)، بلوار بهزاد شمالی، نبش باغستان شماره ۱۲ | ۶-۲۲۰۹۰۰۰۱ ۰۲۱
            </p>
        </div>
        <div class="social">
            <a href="https://www.youtube.com/c/mftplus"><span class="flaticon-youtube"></span></a>
            <a href="https://www.facebook.com/mojtamafanitehran/"><span class="flaticon-facebook-1"></span></a>
            <a href="https://www.instagram.com/mojtamafanitehran/"><span class="flaticon-instagram"></span></a>
            <a href="https://wa.me/+989012707046/?text=%D8%B3%D9%84%D8%A7%D9%85.%D8%A7%D8%B2%20%D8%AE%D8%A8%D8%B1%D9%86%D8%A7%D9%85%D9%87%20%D8%A7%D8%B1%D8%B3%D8%A7%D9%84%DB%8C%20%D8%B4%D9%85%D8%A7%20%D9%BE%DB%8C%D8%A7%D9%85%20%D9%85%DB%8C%D8%AF%D9%87%D9%85/"><span class="flaticon-whatsapp"></span></a>
            <a href="https://t.me/mftedu"><span class="flaticon-paper-plane"></span></a>
            <a href="https://mftehran.tumblr.com/"><span class="flaticon-tumblr"></span></a>
            <a href="https://twitter.com/mftplus"><span class="flaticon-twitter"></span></a>
        </div>
        <div class="links">
                        <div>بخش ها</div>

                            <a class="" href="https://mftplus.com/Publishers"><span class="flaticon-left-arrow"></span>انتشارات</a>
                            <a target="_blank" class="" href="https://gvks.ir/"><span class="flaticon-left-arrow"></span>وبلاگ دکتر سعادت</a>
                            <a class="" href="https://mftplus.com/verifycertificate"><span class="flaticon-left-arrow"></span>استعلام گواهینامه</a>
                            <a class="" href="https://mftplus.com/mfttalent"><span class="flaticon-left-arrow"></span>کاریابی آنلاین (کارتلنت)</a>
                            <a class="" href="https://mftplus.com/hr"><span class="flaticon-left-arrow"></span>واحد سرمایه های انسانی</a>
                    </div>
        <div class="links">
                        <div>درباره ما</div>

                            <a class="" href="https://mftplus.com/student/login"><span class="flaticon-left-arrow"></span>انتقادات ،پیشنهادات و اعتراضات</a>
                            <a class="" href="https://mftplus.com/rules"><span class="flaticon-left-arrow"></span>قوانین و مقررات</a>
                            <a class="" href="https://mftplus.com/academy/saadatabad"><span class="flaticon-left-arrow"></span>تماس با ما</a>
                            <a target="_blank" class="" href="https://mftplus.com/help"><span class="flaticon-left-arrow"></span>راهنمای سامانه مجازی</a>
                            <a class="" href="https://mftplus.com/intro"><span class="flaticon-left-arrow"></span>معرفی مجتمع فنی تهران</a>
                    </div>
        <div class="links">
                        <div>آموزش ها</div>

                            <a class="" href="https://mftplus.com/orgedu"><span class="flaticon-left-arrow"></span>آموزش های سازمانی</a>
                            <a class="" href="https://mftplus.com/international"><span class="flaticon-left-arrow"></span>امور بین الملل</a>
                            <a class="" href="https://mftplus.com/resellers"><span class="flaticon-left-arrow"></span>امور نمایندگی ها</a>
                    </div>
    </div>
    <div class="footer-externals">
        <div>
            <a referrerpolicy="origin" target="_blank" href="https://trustseal.enamad.ir/?id=215203&amp;Code=Fx0fpcpVHEvoxgdLD2gV"><img referrerpolicy="origin" src="./استعلام گواهینامه_files/logo.aspx" alt="" style="cursor:pointer" id="Fx0fpcpVHEvoxgdLD2gV"></a>
        </div>
        <div>
            <a><img referrerpolicy="origin" id="nbqejzpefukznbqeapfufukz" style="cursor:pointer" onclick="window.open(&quot;https://logo.samandehi.ir/Verify.aspx?id=276256&amp;p=uiwkjyoegvkauiwkdshwgvka&quot;, &quot;Popup&quot;,&quot;toolbar=no, scrollbars=no, location=no, statusbar=no, menubar=no, resizable=0, width=450, height=630, top=30&quot;)" alt="logo-samandehi" src="./استعلام گواهینامه_files/logo(1).aspx"></a>
        </div>
        <div>
            <a><img src="./استعلام گواهینامه_files/9f.png"></a>
        </div>
        <div>
            <a><img src="./استعلام گواهینامه_files/10f.png"></a>
        </div>

        <div>
            <a><img src="./استعلام گواهینامه_files/7f.png"></a>
        </div>
        <div>
            <a href="https://sajar.mporg.ir/Company/CompanyDetail?cp=72315&amp;cr=167231&amp;crt=32"><img src="./استعلام گواهینامه_files/3f.png"></a>
        </div>
        <div>
            <a><img src="./استعلام گواهینامه_files/4f.png"></a>
        </div>
        <div>
            <a><img src="./استعلام گواهینامه_files/5f.png"></a>
        </div>
        <div>
            <a><img src="./استعلام گواهینامه_files/6f.png"></a>
        </div>
        <div>
            <a><img src="./استعلام گواهینامه_files/8f.png"></a>
        </div>
    </div>
    <div class="copyright">
...
<script type="text/javascript" async="" src="./استعلام گواهینامه_files/7cf01096-8218-4558-9f76-594b829d7424"></script><script type="text/javascript" async="" src="./استعلام گواهینامه_files/analytics.js.download"></script><script type="text/javascript" async="" src="./استعلام گواهینامه_files/js"></script><script id="ua-script-ymwJ185q" data-analyticsobject="yektanet" async="" type="text/javascript" src="./استعلام گواهینامه_files/rg.complete.js.download"></script><script src="./استعلام گواهینامه_files/jquery-3.5.1.min.js.download"></script>
<script src="./استعلام گواهینامه_files/jquery.mask.min.js.download"></script>
<script src="./استعلام گواهینامه_files/vue.js.download"></script>
<script src="./استعلام گواهینامه_files/in-view.min.js.download"></script>


<script src="./استعلام گواهینامه_files/site.js.download"></script>
<script src="./استعلام گواهینامه_files/apps.js.download"></script>

    <script type="text/javascript">
        if ((document.location.href.includes("/teacher/") || document.location.href.includes("/student/")) && screen.width < 1000) {
            // not chat
        } else {
            ! function() {
                function t() {
                ...
                var e = document,
                    a = window,
                    o = "7cf01096-8218-4558-9f76-594b829d7424";
        ...
        <script async="" src="./استعلام گواهینامه_files/js(1)"></script>
        <script>
...
<script>
    !function (t, e, n) {
        ...
        s.id = "ua-script-ymwJ185q"; s.dataset.analyticsobject = n;
        s.async = 1; s.type = "text/javascript";
        s.src = "https://cdn.yektanet.com/rg_woebegone/scripts_v3/ymwJ185q/rg.complete.js?v=" + r, c.parentNode.insertBefore(s, c)
        ...
        <iframe id="raychat_widget" class="raychat_frame" title="raychat widget" allow="microphone" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true" allowtransparency="true" scrolling="no" style="transition: none 0s ease 0s;" src="./استعلام گواهینامه_files/saved_resource.html"></iframe></body><grammarly-desktop-integration data-grammarly-shadow-root="true"><template shadowrootmode="open"><style>
